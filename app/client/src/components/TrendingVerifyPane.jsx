  ...
  const verificationData = {
    '@crypto_phantom': {
      ...
      sources: [
        ...
        {
          name: 'Hiệp hội An toàn thông tin (AISANet)',
    ...
    '@narrative_weaver': {
      ...
      sources: [
        {
          name: 'Tài liệu Kỹ thuật HypeRoom (Whitepaper v2)',
        ...
        {
          name: 'Báo Công Nghệ Số (TechNews)',
    ...
    '@void_operator': {
      ...
      sources: [
        {
          name: 'Trạm Giám sát Mạng Quốc gia (vnNIC)',
        ...
        {
          name: 'Cổng trạng thái HypeRoom (Status Portal)',
      ...
      outline: [
        ...
        '   - Giải thích nguyên nhân hệ thống báo OK (máy chủ vẫn chạy) nhưng người dùng lỗi kết nối (do nghẽn mạng cục bộ).',
        ...
        {verified && (
          <div className="flex flex-col gap-6 overflow-y-auto max-h-[480px] pr-2 custom-scrollbar">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-[#faf8f2] border border-[#5c4a43]/15 p-4 rounded-lg flex flex-col items-center justify-center">
                <RadialProgress value={currentVerify.publicImpact} color="#BDE8F5" />
            ...
            <div>
              ...
              <div className="space-y-3">
                {currentVerify.sources.map((source, idx) => (
                  <div key={idx} className="bg-[#faf8f2] border border-[#5c4a43]/15 p-3.5 rounded-lg flex flex-col gap-1.5">
            ...
            <div className="border-t border-[#5c4a43]/15 pt-4">
              {!outlineGenerated && !outlineLoading && (
                ...
                >
                  ...
                  TẠO DÀN Ý PHẢN BÁC TIN TỨC (GEMINI AI)
                </button>
              )}
              ...
              {outlineGenerated && (
                <div className="relative rotate-[0.5deg] mt-3">
                  ...
                  <div className="p-5 rounded bg-[#fbf9e3] border border-[#5c4a43]/20 shadow-md">
                    ...
                    <div className="font-data-mono text-[11px] text-[#1e1613] leading-relaxed whitespace-pre-wrap space-y-1.5">
